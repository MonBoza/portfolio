const Contact = () => {
  return(
    <div id="ContactMe" className="p-4  lg:p--20 flex flex-col items-center justify-center">
      ...
      <textarea data-aos="fade-up" className="w-full my-3 rounded-lg bg-slate-700 p-4 border-2 border-blue-800 b_glow" name="Message" id="Message" cols="20" rows="10" placeholder="Message"></textarea>
